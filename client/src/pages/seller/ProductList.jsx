...
const ProductList = () => {
    ...
    const toggeleStock = async (id,inStock) => {
        try {
                                ...
                                <tr key={product._id} className="border-t border-gray-500/20">
                                    ...
                                    <td className="px-4 py-3">
                                        <label className="relative inline-flex items-center cursor-pointer text-gray-900 gap-3">
                                            <input onClick={() => toggeleStock(product._id, !product.inStock)} type="checkbox" className="sr-only peer" checked={product.inStock}  />
