  ...
  return (
    <div className='relative'>
      ...
      <div className='absolute inset-0 flex flex-col items-center md:items-start justify-end md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
        <h1 className='text-3xl md:text-4xl lg:text-5x font-bold text-center md:text-left max-w-72 md:max-w-80 lg:max-wd-105 leading-tight lg:leading-15'>
            Fressness you can Trust, Servings you will Love!
        </h1>
