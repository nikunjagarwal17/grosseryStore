...
const Login = () => {
    ...
    const {setUser,navigate,axios, setShowUserLogin} = useAppContext();
    ...
    return (
        <div onSubmit={onSubmitHandler} onClick={()=>setShowUserLogin(false)} className="fixed top-0 bottom-0 left-0 right-0 z-30 flex items-center text-sm text-grey-600 bg-black/50">
